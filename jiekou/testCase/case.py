...
# @Author  : lileilei
# @File    : case.py
from jiekou.Interface.testFengzhuang import TestApi
from jiekou.Public.get_excel import datacel
from jiekou.Public.log import LOG, logger
import os
from jiekou.config.config_T import Config_Try_Num,TestPlanUrl
path = os.getcwd() + '\\test_case_data\\case.xlsx'
listid, listkey, listconeent, listurl, listfangshi, listqiwang, listname = datacel(path)
from jiekou.Public.panduan import assert_in
@logger('测试')
def testinterface():
    list_pass = 0
    list_fail = 0
