...
def phonebook_save(L):
    with open("D:\pycharm\python\Chapter-01-code\data.dat","w") as f:
        json.dump(L,f)

def phonebook_load(L):
    global  record_list
    with open("D:\pycharm\python\Chapter-01-code\data.dat","r") as f:
        record_list = json.load(L)
        global record_id
