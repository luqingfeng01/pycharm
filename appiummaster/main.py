...
"""
'''主运行文件'''
from appiummaster.untils.pyreport_excel import create
import  unittest,random,datetime
from appiummaster.untils.log import LOG,logger
from  appiummaster.untils.makecase import makecasefile
from multiprocessing import Pool
from  appiummaster.testcase.regcasetest import regtest
from  appiummaster.untils.Parmeris import Parmer
from appiummaster.untils.AppiumServer import AppiumServer
from  appiummaster.untils.BaseApk import getPhoneInfo,AndroidDebugBridge
import os
l_devices=[]
@logger('生成设备配置链接的进程池')
